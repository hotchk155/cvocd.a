...
void preset1() 
{
	...
	nrpn(NRPNH_STACK1, NRPNL_CHAN, NRPVH_CHAN_GLOBAL, 0);
	nrpn(NRPNH_STACK1, NRPNL_PRIORITY, 0, PRIORITY_LOW);
	nrpn(NRPNH_STACK1, NRPNL_NOTE_MAX, 0, 35);
	
	
	
	nrpn(NRPNH_STACK2, NRPNL_CHAN, NRPVH_CHAN_GLOBAL, 0);
	nrpn(NRPNH_STACK2, NRPNL_PRIORITY, 0, PRIORITY_LOW);
	nrpn(NRPNH_STACK2, NRPNL_NOTE_MIN, 0, 36);
	
	nrpn(NRPNH_CV1, NRPNL_SRC, NRPVH_SRC_STACK1, NRPVL_SRC_NOTE1);
	nrpn(NRPNH_CV2, NRPNL_SRC, NRPVH_SRC_STACK2, NRPVL_SRC_NOTE1);

	nrpn(NRPNH_GATE1, NRPNL_SRC, NRPVH_SRC_STACK1, NRPVL_SRC_NOTE1_TRG);
	nrpn(NRPNH_GATE2, NRPNL_SRC, NRPVH_SRC_STACK2, NRPVL_SRC_NOTE1);
