...
void preset1() 
{
	...
	//nrpn(NRPNH_STACK2, NRPNL_PRIORITY, 0, PRIORITY_HIGH);
	
	nrpn(NRPNH_CV1, NRPNL_SRC, NRPVH_SRC_STACK1, NRPVL_SRC_NOTE1);
	nrpn(NRPNH_CV2, NRPNL_SRC, NRPVH_SRC_STACK1, NRPVL_SRC_NOTE2);

	nrpn(NRPNH_GATE1, NRPNL_SRC, NRPVH_SRC_STACK1, NRPVL_SRC_NOTE1_TRG);
	nrpn(NRPNH_GATE2, NRPNL_SRC, NRPVH_SRC_STACK1, NRPVL_SRC_NOTE2);
