...
enum {
	...
	PRIORITY_PARA			= 12,	// paraphonic mode
	PRIORITY_PARA_RELEASE	= 13,	// paraphonic mode keeping voicing on release
...
void cv_dac_prepare(void);
byte *cv_storage(int *len);

// STORAGE
void storage_read_patch(void);
void storage_write_patch(void);
