...
#define P_BLUE_LED        16
#define P_RED_LED1        17
#define P_RED_LED2        18
#define P_GREEN_LED       19
#define P_YELLOW_LED      20
#define P_RED_LED3        21
...
void setup() {  
  ...
  pinMode(P_BLUE_LED, OUTPUT);
  pinMode(P_RED_LED1, OUTPUT);
  pinMode(P_RED_LED2, OUTPUT);
  pinMode(P_GREEN_LED, OUTPUT);
  pinMode(P_YELLOW_LED, OUTPUT);
  pinMode(P_RED_LED3, OUTPUT);
  ...
  SPI.transfer(0b00000110); // set ext ref
...
int read_mv(int ch) {
  ...
  unsigned result = ((unsigned)b1)<<8 | b0;
  return result;
}
...
void loop() {
  ...
  Serial.print(read_mv(0), DEC);
  Serial.print(" ");
  Serial.print(read_mv(1), DEC);
  Serial.print(" ");
  Serial.print(read_mv(2), DEC);
  Serial.print(" ");
  Serial.print(read_mv(3), DEC);
  Serial.println(" ");
  delay(100);
  /*
